...
-- Description:
-- Clean semi-monthly payroll reporting view
-- =========================================
...
SELECT
    ...
    COUNT(DISTINCT ar.attendance_date)
        AS days_worked,
